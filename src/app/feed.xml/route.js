...
export async function GET(req) {
  ...
  let author = {
    name: 'Zachary Aagesen',
    email: 'zacharyaagesen@gmail.com',
  }

  let feed = new Feed({
    title: author.name,
    description: 'Jeg hedder Zachary, og er webudvikler fra Nyborg. Jeg er far, og så har jeg en masse andre interesser.',
    author,
    id: siteUrl,
    link: siteUrl,
